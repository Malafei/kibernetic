...
import { SheduleLessonsAdd } from './Action';
import { useRef, useState } from "react";
import validationFieldsLessons from './ValidationLessons';
...
const AddLessonsToShedule = ({ visible, onClose }) => {
    ...
    const onSubmitHandler = (values) => {
        ...
        dispatch(SheduleLessonsAdd(formData))
        .then(result => {
            console.log("good");
            console.log(result);
            onClose();
            ...
            <div className="album py-5">
                <div className='Body-shedual-admin'>
                    ...
                    <Formik
                        ...
                        validationSchema={validationFieldsLessons()}>
                        <Form>
